...
[![Build status](https://img.shields.io/github/actions/workflow/status/anthonyleestark/darkwin32/run-build.yml?logo=Github)](https://github.com/anthonyleestark/darkwin32/actions)
[![Latest release](https://img.shields.io/github/v/release/anthonyleestark/darkwin32?include_prereleases)](https://github.com/anthonyleestark/darkwin32/releases/latest)
[![MIT License](https://img.shields.io/github/license/anthonyleestark/darkwin32)](./LICENSE.md)

## Description

**DarkWin32** is a lightweight C++ static library that enables native dark mode support for Win32 applications on Windows 10 and later. It builds upon and enhances existing open-source efforts to provide reliable and modern dark mode integration for legacy and custom UI applications.
...
See the [licenses/](./license) folder for more information.
